  ...
  const myProject = [
    {
      ...
      githubUrl: "https://github.com/fadlifathurrahman/travel-gallery",
    ...
    },
    {
      ...
      githubUrl: "https://github.com/fadlifathurrahman/google-classroom",
    ...
    },
    {
      ...
      demoUrl: "",
      view: tiketGo,
      expertise: [myExpertise[2].id, myExpertise[8].id, myExpertise[10].id, myExpertise[11].id, myExpertise[12].id],
    },
    {
      name: "Integer Store",
      desc: "CRUD React project for React training Task",
      githubUrl: "https://github.com/fadlifathurrahman/integer-store.git",
      demoUrl: "https://https://integer-store-bay.vercel.app/",
      view: integerStore,
      expertise: [myExpertise[6].id, myExpertise[11].id],
    },
    {
      name: "Caruban Tourism",
      desc: "Cirebon tourism and culinary website",
      githubUrl: "https://github.com/fadlifathurrahman/caruban-tourism",
      demoUrl: "",
      view: carubanTourism,
